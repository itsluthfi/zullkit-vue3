...
const categories = ref([
    ...
    { id: 3, title: 'Icon Set', 'count': 85339, 'image': 'categories-3.jpg' },
...
<template>
    <div class="container px-4 mx-auto my-16 md:px-12">
        ...
        <div class="flex flex-wrap -mx-1 lg:-mx-4">
            <CategoryCard v-for="category in categories" :key="category.id" :title="category.title" :count="category.count"
